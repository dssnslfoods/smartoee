  ...
  /* -------- Roles & Permissions -------- */
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'Supervisor มีสิทธิ์ทุกอย่างเหมือน Staff เพิ่มเติม: เข้าถึงเครื่องจักรทั้งหมดในบริษัทโดยอัตโนมัติ ตรวจสอบ/คำนวณ OEE/อนุมัติ/ล็อคกะ สร้างบัญชี Staff ใหม่ จัดการกลุ่มสิทธิ์เครื่องจักร สร้างมาตรฐานการผลิต และดู Audit Log ของโรงงาน',
      },
      {
    ...
    items: [
      {
        ...
        a: 'ประกอบด้วย 4 แท็บ: (1) สรุปกะ - ดู OEE, อนุมัติ/ล็อคกะ (2) กลุ่มสิทธิ์ - จัดการ Permission Group (3) จัดการพนักงาน - สร้าง/แก้ไขบัญชี Staff (4) Audit Log - ดูประวัติการเปลี่ยนแปลงข้อมูล',
      },
      {
      ...
      {
        q: 'Supervisor สร้างบัญชี Staff อย่างไร?',
        a: 'ไปที่แท็บ "จัดการพนักงาน" → กดปุ่มเพิ่มพนักงาน → กรอกชื่อ, Email, รหัสผ่าน → บัญชีจะถูกสร้างในบริษัทเดียวกับ Supervisor โดยอัตโนมัติ Supervisor สามารถแก้ไข Email, ชื่อ, รหัสผ่านของ Staff ในบริษัทตนเองได้',
      },
    ],
  },
