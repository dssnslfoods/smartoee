...
const helpSections: HelpSection[] = [
  /* -------- System Overview -------- */
  {
    ...
    items: [
      ...
      {
        q: "Auto-Close Event คืออะไร?",
        a: "Auto-Close เป็นกลไกอัตโนมัติที่ปิดเหตุการณ์ (RUN/DOWNTIME/SETUP) ที่ค้างเปิดอยู่เมื่อเวลากะสิ้นสุดลง ระบบตรวจสอบทุก 5 นาที หากพบ event ที่ end_ts ยังว่างและกะสิ้นสุดแล้ว จะปิดอัตโนมัติด้วย end_ts = เวลาสิ้นสุดกะ พร้อมบันทึกใน Audit Log ว่า 'Auto-closed: สิ้นสุดเวลากะ' ช่วยป้องกันข้อมูลผิดพลาดเมื่อ Staff ลืมกด Stop",
      },
    ],
  },
  ...
  /* -------- Pending Counts -------- */
  {
    ...
    items: [
      ...
      {
        q: "การบันทึกรวม (Bulk Record) ทำงานอย่างไร?",
        a: "เมื่อมีหลายเหตุการณ์ RUN ของเครื่องจักรและ SKU เดียวกัน ระบบจะจัดกลุ่มรวมให้โดยอัตโนมัติ แสดงปุ่ม 'บันทึกรวมได้' เพื่อให้กรอกจำนวนรวมครั้งเดียว แล้วระบบจะแบ่งจำนวนไปแต่ละเหตุการณ์ให้อัตโนมัติ",
      },
      {
        q: "วิธีแบ่งจำนวน (Split Mode) มีกี่แบบ?",
        a: "มี 2 แบบ:\n\n1. แบ่งตามสัดส่วนเวลา (Proportional) — ค่าเริ่มต้น: แบ่งจำนวนตามสัดส่วนระยะเวลาของแต่ละเหตุการณ์ เช่น เหตุการณ์ที่ RUN นาน 20 นาทีจะได้จำนวนมากกว่าเหตุการณ์ที่ RUN นาน 10 นาที\n\n2. แบ่งเท่าๆ กัน (Equal) — แบ่งจำนวนเท่ากันทุกเหตุการณ์ โดยไม่สนระยะเวลา\n\nสลับโหมดได้จากปุ่มที่อยู่เหนือฟอร์มบันทึกจำนวน",
      },
      {
        q: "Preview การแบ่งจำนวนคืออะไร?",
        a: "เมื่อกรอกจำนวนชิ้นงานดี (Good Qty) หรือของเสีย (Reject Qty) ในโหมดบันทึกรวม ระบบจะแสดง Preview แบบ Real-time ด้านล่างฟอร์ม แสดงรายการเหตุการณ์แต่ละรายการพร้อม:\n• ช่วงเวลาและระยะเวลา\n• จำนวน Good/Reject ที่จะถูกแบ่งไป\n\nPreview จะอัปเดตทันทีเมื่อเปลี่ยนจำนวนหรือสลับโหมดการแบ่ง ช่วยให้ตรวจสอบความถูกต้องก่อนกด Submit",
      },
      {
  ...
  /* -------- Troubleshooting -------- */
  {
    ...
    items: [
      ...
      {
        q: "เหตุการณ์ถูก Auto-Close แสดง 'สิ้นสุดเวลากะ' คืออะไร?",
        a: "หมายความว่าเหตุการณ์ถูกปิดอัตโนมัติโดยระบบเมื่อหมดเวลากะ เนื่องจาก Staff ลืมกด Stop ระบบจะตั้ง end_ts = เวลาสิ้นสุดกะ และเพิ่มหมายเหตุ 'Auto-closed: สิ้นสุดเวลากะ' ข้อมูลจำนวนผลิตจะยังไม่ได้บันทึก ต้องไปกรอกเพิ่มที่หน้า Pending Counts ก่อน Supervisor คำนวณ OEE",
      },
      {
  ...
  /* -------- Best Practices -------- */
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'อย่ารอจบกะค่อยกรอกข้อมูลย้อนหลัง, อย่าแชร์บัญชี Login กับคนอื่น, อย่าเปิดเหตุการณ์ค้างไว้เมื่อเครื่องหยุดจริง (แม้ระบบจะ Auto-Close ให้เมื่อหมดกะ แต่ควรกด Stop เองเพื่อบันทึกเวลาจริง), อย่าข้ามขั้นตอนการคำนวณก่อนอนุมัติกะ, อย่า Deactivate ข้อมูลหลักโดยไม่พิจารณาผลกระทบ, อย่าใช้สาเหตุ "อื่นๆ" ทุกครั้งสำหรับ Downtime',
      },
      {
        q: "ตารางปฏิบัติงานรายวันแนะนำ",
        a: "เริ่มกะ: Staff เลือกเครื่องจักร+SKU กด Start Run → ระหว่างกะ: บันทึกเหตุการณ์ตามจริง กรอกจำนวนผลิตเป็นระยะ → จบกะ: หยุดเหตุการณ์ทั้งหมด กรอกจำนวนผลิตสุดท้าย ตรวจสอบ Pending Counts → หลังจบกะ: Supervisor ตรวจสอบ คำนวณ OEE อนุมัติ ล็อค (หมายเหตุ: หาก Staff ลืมกด Stop ระบบจะ Auto-Close ให้เมื่อหมดกะ แต่จำนวนผลิตต้องไปกรอกเพิ่มที่ Pending Counts)",
      },
    ],
  },
];
